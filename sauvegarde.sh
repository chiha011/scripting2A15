...
;;
        a)
        #Appel de la fonction pour archiver dans une « archive tar » tous les fichiers de votre répertoire personnel (/home/chiha) qui ont été modifiés dans les dernières 24 heures 
        clear
        echo -e "\e[1;92m   Vous avez selectioner la fonction pour archiver tous les fichiers de votre répertoire personnel (/home/chiha) qui ont été modifiés dans les dernières 24 heures : \e[0m " 
